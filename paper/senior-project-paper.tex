...
fast and easy to setup: if have any idea, can immediately test it out.
brige n gap between research and industry, idea and realization
Graph: computation as node, tensor data flow as edges. 
temporal logic control
versatile structure - can compute on subgraph for testing. Replacement, injection
resource distribution - multi devices, taken care of. Phone. OMGGG
tensor library
all backend complexities taken care of in the background
