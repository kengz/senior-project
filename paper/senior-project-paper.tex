...
\subsubsection{ANN with Deep Learning (DNN)}
...
\caption{DNN that mimics the hierarchical structure of the brain. Going from left to right, features get generalized from the specifics into more abstract representations. \href{http://devblogs.nvidia.com/parallelforall/accelerate-machine-learning-cudnn-deep-neural-network-library/}{\tt Image source from NVIDIA.}}\label{ANN-fig}
\end{figure}
